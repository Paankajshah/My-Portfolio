  ...
  return (
    <div className={classes.container}>
      <div className={classes.viewPage}>
        ...
        <div className={classes.myselfContainer}>
          <p ref={(el) => (text = el)} className={classes.myself}>
            I am final year IT student studying in Advanced College of
            Engineering and Management. I have a great afinity towards making
            interesting stuffs mostly with JS. ReactJs is what I love and want
            to explore more. for more please view my Resume.
